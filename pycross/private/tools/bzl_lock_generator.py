...
class Naming:
    ...
    def py_wheel_target(self, package_key: str) -> str:
        return (
            self._prefixed(self._sanitize(package_key), self.py_wheel_prefix) + "_whl"
        )

    def py_wheel_label(self, package_key: str):
