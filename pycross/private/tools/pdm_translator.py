...
# FIXME dirty hack to "fix" pdm-namespace shadowing ...
for p in sys.path:
    if "pdm_pep517/site-packages" in p:
        os.remove(f"{p}/pdm/__init__.py")

from pdm.core import Core as PDMCore
from pdm.project import Project as PDMProject
from pdm.models.candidates import Candidate as PDMCandidate, Link as PDMLink
...
def get_pins(project: Project) -> Dict[str, str]:
    pins = {}
...
def main() -> None:
    ...
    lock_set = translate(args.pdm_project_file, args.pdm_lock_file)
