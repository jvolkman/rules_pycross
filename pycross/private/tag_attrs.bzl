...
load(
    ...
    _PDM_WORKSPACE_MEMBERS_ATTRS = "PDM_WORKSPACE_MEMBERS_ATTRS",
    _PDM_WORKSPACE_MEMBER_ATTRS = "PDM_WORKSPACE_MEMBER_ATTRS",
...
PDM_WORKSPACE_MEMBERS_ATTRS = _PDM_WORKSPACE_MEMBERS_ATTRS
PDM_WORKSPACE_MEMBER_ATTRS = _PDM_WORKSPACE_MEMBER_ATTRS
