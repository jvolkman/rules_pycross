...
load(
    ...
    _PDM_ALL_MEMBERS_ATTRS = "PDM_ALL_MEMBERS_ATTRS",
    _PDM_IMPORT_ATTRS = "PDM_IMPORT_ATTRS",
    _PDM_MEMBER_ATTRS = "PDM_MEMBER_ATTRS",
    _PDM_WORKSPACE_ATTRS = "PDM_WORKSPACE_ATTRS",
    _POETRY_IMPORT_ATTRS = "POETRY_IMPORT_ATTRS",
    _POETRY_MEMBER_ATTRS = "POETRY_MEMBER_ATTRS",
    _PYLOCK_IMPORT_ATTRS = "PYLOCK_IMPORT_ATTRS",
    _PYLOCK_MEMBER_ATTRS = "PYLOCK_MEMBER_ATTRS",
    _REGISTER_TOOLCHAINS_ATTRS = "REGISTER_TOOLCHAINS_ATTRS",
    _UV_ALL_MEMBERS_ATTRS = "UV_ALL_MEMBERS_ATTRS",
    _UV_IMPORT_ATTRS = "UV_IMPORT_ATTRS",
    _UV_MEMBER_ATTRS = "UV_MEMBER_ATTRS",
...
PDM_WORKSPACE_ATTRS = _PDM_WORKSPACE_ATTRS
PDM_ALL_MEMBERS_ATTRS = _PDM_ALL_MEMBERS_ATTRS
PDM_MEMBER_ATTRS = _PDM_MEMBER_ATTRS
UV_IMPORT_ATTRS = _UV_IMPORT_ATTRS
UV_WORKSPACE_ATTRS = _UV_WORKSPACE_ATTRS
UV_ALL_MEMBERS_ATTRS = _UV_ALL_MEMBERS_ATTRS
UV_MEMBER_ATTRS = _UV_MEMBER_ATTRS
POETRY_IMPORT_ATTRS = _POETRY_IMPORT_ATTRS
POETRY_MEMBER_ATTRS = _POETRY_MEMBER_ATTRS
PYLOCK_IMPORT_ATTRS = _PYLOCK_IMPORT_ATTRS
PYLOCK_MEMBER_ATTRS = _PYLOCK_MEMBER_ATTRS
