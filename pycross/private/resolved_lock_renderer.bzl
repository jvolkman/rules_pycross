...
def render_lock_bzl(lock, repo_map, rctx_name):
    ...
    env_lines.append("package(default_visibility = [\"//:__subpackages__\"])")
    env_lines.append("")
    ...
    if cycle_groups:
        ...
        cycle_lines.append("package(default_visibility = [\"//:__subpackages__\"])")
        cycle_lines.append("")
    ...
    for pkg_key, pkg in sorted(packages.items()):
        ...
        lines.append("package(default_visibility = [\"//:__subpackages__\"])")
        lines.append("")
        lines.append("load(\"@rules_pycross//pycross:defs.bzl\", \"pycross_dist_info\", \"pycross_wheel_library\")")
        lines.append("")
        ...
        # dist_info for rules_python py_console_script_binary compatibility
        lines.append("pycross_dist_info(")
        lines.append("    name = \"dist_info\",")
        lines.append("    pkg = \":{}\",".format(target_name_pkg))
        lines.append(")")
        lines.append("")
