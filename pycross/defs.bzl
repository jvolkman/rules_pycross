...
load("//pycross/private:build_recipe.bzl", _pycross_build_recipe = "pycross_build_recipe")
...
load("//pycross/private:providers.bzl", _PycrossBuildRecipeInfo = "PycrossBuildRecipeInfo", _PycrossWheelInfo = "PycrossWheelInfo")
...
pycross_build_recipe = _pycross_build_recipe
pycross_meson_recipe = _pycross_meson_recipe
