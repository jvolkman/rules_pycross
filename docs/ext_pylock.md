...
pylock.workspace(<a href="#pylock.workspace-name">name</a>, <a href="#pylock.workspace-disallow_builds">disallow_builds</a>, <a href="#pylock.workspace-extra_project_files">extra_project_files</a>, <a href="#pylock.workspace-incompatible_wheel_fallback">incompatible_wheel_fallback</a>,
                 <a href="#pylock.workspace-local_wheels">local_wheels</a>, <a href="#pylock.workspace-lock_file">lock_file</a>, <a href="#pylock.workspace-pypi_indexes">pypi_indexes</a>)
</pre>
...
| <a id="pylock.workspace-incompatible_wheel_fallback"></a>incompatible_wheel_fallback |  If True, defer failures for incompatible wheels from analysis to execution.   | Boolean | optional |  `False`  |
