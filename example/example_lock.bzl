...
def targets():
    ...
    pycross_wheel_library(
        ...
        wheel = select({
            ...
            ":_env_python_darwin_arm64": ":_build_greenlet",
    ...
    pycross_wheel_library(
        ...
        wheel = select({
            ...
            ":_env_python_darwin_arm64": ":_build_sqlalchemy",
