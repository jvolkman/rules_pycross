...
def targets():
    ...
    pycross_wheel_library(
        ...
        wheel = "@pdm_lock_wheel_prompt_toolkit_3.0.40_py3_none_any//file",
    )
...
def repositories():
    ...
    maybe(
        http_file,
        name = "pdm_lock_wheel_prompt_toolkit_3.0.40_py3_none_any",
        urls = [
            "https://files.pythonhosted.org/packages/ed/29/cd63ff872dfc213e1cd8131f8060262db184b975868cef33302f44616c3e/prompt_toolkit-3.0.40-py3-none-any.whl"
        ],
        sha256 = "99ba3dfb23d5b5af89712f89e60a5f3d9b8b67a9482ca377c5771d0e9047a34b",
        downloaded_file_path = "prompt_toolkit-3.0.40-py3-none-any.whl",
    )
